<template>
  ...
  <ion-content :fullscreen="true">
    <ion-header collapse="condense">
      <ion-toolbar>
        <ion-title size="large">Home Listing test</ion-title>
   ...
   <div id="container">
     ...
     <br>
      <div id="nav">
       ...
       <ion-button @click="() => router.push('/page')">Go to Page</ion-button>
       <ion-button @click="() => router.push('/detail')">Go to detail</ion-button>
       <!-- <router-view /> -->
   </div>
  <ion-list>
    <ion-item href="/java1">
      <ion-label>java1</ion-label>
    </ion-item> 

    <ion-item href="/java2">
      <ion-label>java2</ion-label>
    </ion-item>
    <ion-item href="/java3">
      <ion-label>java3</ion-label>
    </ion-item>
    <ion-item href="/java4">
      <ion-label>java4</ion-label>
    </ion-item>
  </ion-list>
